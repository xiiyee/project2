<template>
  ...
  >
    ...
    >
      ...
      <Transition name="slide" @before-enter="isMenuTransitioning = true" @after-enter="isMenuTransitioning = false" @before-leave="isMenuTransitioning = true" @after-leave="isMenuTransitioning = false">
        <div 
          v-if="mobileMenuOpen" 
          :class="[
